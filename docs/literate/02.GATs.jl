...
@signature Category(Ob,Hom) => FreeSymmetricMonoidalCategory(Ob,Hom) begin
	otimes(A::Ob, B::Ob)::Ob
...
md"This program encodes and can be automatically converted to the following morphism in the theory:"
